...
class AllClientePedido {
    ...
    factory AllClientePedido.fromJson(String str) => AllClientePedido.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory AllClientePedido.fromMap(Map<String, dynamic> json) => AllClientePedido(

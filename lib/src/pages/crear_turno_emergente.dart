...
class CreaTurnoEmergente extends StatefulWidget {
  final String? tipo;
  const CreaTurnoEmergente({Key? key, this.tipo}) : super(key: key);
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              //***********************************************/
                              Spacer(),
                              Consumer<MultasGuardiasContrtoller>(builder: (_, _valueProv, __) {  
                                return (_valueProv.getNomClienteMulta ==
                                                  '' ||
                                              _valueProv.getNomClienteMulta ==
                                                  null)?
                                                  Container()
                                                  :ClipRRect(
                          ...
                          controllerMulta.setNomCliente( controllerMulta.getNomClienteMulta);
                           await controllerMulta.getTodosLosPuestosDelCliente(controllerMulta.getCedClienteMulta);
 }else if(widget.tipo=='PERMISO'){
                                  final controllerAusencia = context.read<AusenciasController>();
                                        controllerMulta.setNomCliente(controllerAusencia.nombreCliente);
                                       await controllerMulta.getTodosLosPuestosDelCliente('2360006130001');

...
class ListaFaltasInjustificadas extends StatefulWidget {
  final Session? user;
  const ListaFaltasInjustificadas({Key? key, this.user}) : super(key: key);

  @override
  State<ListaFaltasInjustificadas> createState() => _ListaFaltasInjustificadasState();
}
...
class _ListaFaltasInjustificadasState extends State<ListaFaltasInjustificadas> {
  ...
  final _user=context.read<HomeController>().getUsuarioInfo;
                                        ...
                                        children: [
                                          ...
                                          ClipRRect(
                                            ...
                                            child: GestureDetector(onTap: () {
                                              _modalSeleccionaTipo(context,size, multasControler);
              ...
              Expanded(
                child: Consumer<MultasGuardiasContrtoller>(
                  builder: (_, providers, __) {
                    // if (providers.getErrorFaltasInjustificadas == null) {
                    //   return Center(
                    //     child: Column(
                    ...
                    //     ),
                    //   );
                    // } else if (providers.getErrorFaltasInjustificadas == false) {
                    //   return const NoData(
                   ...
                   else if (providers.getListaFaltasInjustificadas.isEmpty) {
                    return const NoData(
                      label: 'No existen datos para mostar',
                    );
                  } 
                  else if (providers
                      .getListaFaltasInjustificadas.isEmpty) {
                    return Center(
                      // child: CircularProgressIndicator(),
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                            ...
                            return valueEstadoInter.serverStatus == ServerStatus.Online
                                ? ListView.builder(
                                    itemCount: multasControler
                                        .getListaFaltasInjustificadas.length,
                                    itemBuilder: (BuildContext context, int index) {
                                      final multas = multasControler
                                          .getListaFaltasInjustificadas[index];
              
              
                                            String fechaLocal = DateUtility.fechaLocalConvert( multas['nomFecha']!.toString());
                    //============FECHA UTC=================//
                    
         
  DateTime dateTime = DateTime.parse(fechaLocal);
                                      ...
                                      return Slidable(
                                        startActionPane: ActionPane(
                                          ...
                                          children: [
                                            ...
                                            //     : Container(),
                                                           multas['nomEstado'] == 'EN PROCESO'
                                             && multas['nomPorcentaje'].toString()=='10' 
              ...
              // ====== TOMO LOS DATOS DEL GUARDIA MULTADO =======//
                ...
                // =================================================//
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                           final _control= context.read<MultasGuardiasContrtoller>();
                                           final _controll= context.read<AusenciasController>();
                                              
                                                  _control.setInfoFalta(multas);
                                                  // _control.buscaListaGuardiasReemplazo([multas['idTurno'].toString()]);
                                                  _controll.resetValuesAusencias();
                                                  _controll.buscaListaGuardiasReemplazo([multas['idTurno'].toString()]);
                                            Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                    builder: ((context) =>
 ...
 //======================= ACTUALIZA LA PANTALLA============================//
  ...
  final _controls= context.read<MultasGuardiasContrtoller>();
                   _controls.getTodasLasFaltasInjustificadas('');
  }
  //===================================================//

  //====== MUESTRA MODAL DE MOTIVO =======//
  void _modalSeleccionaTipo(BuildContext context, size, MultasGuardiasContrtoller actividades) {
    final _data = [
      'Diurno',
      'Nocturno',
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            actividades.setLabelFaltas(_data[index]);
                            onRefresh(  context);
                            Navigator.pop(context);
                          },
                          child: Container(
        ...
        builder: (BuildContext context) {
          return GestureDetector(
            ...
            child: AlertDialog(
              insetPadding: EdgeInsets.symmetric(
                  horizontal: size.wScreen(5.0), vertical: size.wScreen(3.0)),
              content: Consumer<TurnoExtraController>(builder: (_, valueGuardia, __) { 
                return  
                ...
                children: [
                 ...
                 valueGuardia.getListaIdPersona.isEmpty? Text('Cargando Información ....',
                      style: GoogleFonts.lexendDeca(
                        fontSize: size.iScreen(1.7),
                        fontWeight: FontWeight.normal,
                        // color: Colors.white,

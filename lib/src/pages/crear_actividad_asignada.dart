...
class CrearActividadDesignada extends StatefulWidget {
  ...
  const CrearActividadDesignada({Key? key, required this.requeridos}) : super(key: key);

  @override
  State<CrearActividadDesignada> createState() => _CrearActividadDesignadaState();
}
          ...
          inputFormatters: <TextInputFormatter>[
            FilteringTextInputFormatter.allow(
               ...
               RegExp(r'^[^\n"]*$')),
                                      ...
                                      onChanged: (text) {
                                        _controller.setInputTitulo(text);
                                      },
                                      validator: (text) {
            ...
            //                               //*****************************************/
                ...
                _controller.getDataRows.isNotEmpty?  Consumer<ActividadesAsignadasController>(builder: (_, valueDS,__) {  
                    ...
                    source: ListaInventarioInternoDTS(valueDS,'NUEVO' ),
            ...
            //                               //*****************************************/
                ...
                _controller.getDataRowsArmas.isNotEmpty?  Consumer<ActividadesAsignadasController>(builder: (_, valueArmasDS,__) {  
                    ...
                    source: ListaInventarioInternoArmasDTS(valueArmasDS,'NUEVO'),
            ...
            //                               //*****************************************/
                ...
                _controller.getDataRowsMuniciones.isNotEmpty?  Consumer<ActividadesAsignadasController>(builder: (_, valueMunicionesDS,__) {  
                    ...
                    source: ListaInventarioInternoMunicionesDTS(valueMunicionesDS,'NUEVO'),
          ...
          conexion == ConnectivityResult.mobile) {
            ...
            if (response != null) {
              ...
              Navigator.pop(context);
                    ...
                    _actividadController.borrarDatos();
                    _actividadController.agruparProductos();
                  
              _actividadController.getActividadesAsignadas('','false');

            }else {
               NotificatiosnService.showSnackBarError('Problemas al guardar registro');
            }

...
class ListaNuevosPermisos extends StatefulWidget {
  const ListaNuevosPermisos({Key? key}) : super(key: key);
...
class _ListaNuevosPermisosState extends State<ListaNuevosPermisos> {
  ...
  void initData() async {
    final loadInfo = Provider.of<NuevoPermisoController>(context, listen: false);
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
         ...
         flexibleSpace: Container(
              ...
              children: [
                Container(
                 padding: EdgeInsets.only(
                  ...
                  child: Consumer<NuevoPermisoController>(builder: (_, provider, __) {
                          ...
                          return Slidable(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                  ...
                                  final List<String>_ids=[];
                                         for (var item in  ausencia['permiIdsTurnoExtra']) {
                                          _ids.addAll([item.toString()]);
                                         }
            ...
            || _usuario.rol!.contains('ADMINISTRACION')
                ? FloatingActionButton(
                    // backgroundColor: primaryColor,
                    child: const Icon(Icons.add),
                    onPressed: () {
                      final ausenciaController =Provider.of<NuevoPermisoController>(context,listen: false);

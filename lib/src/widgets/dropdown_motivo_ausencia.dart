...
class DropMenuMotivoAusencia extends StatelessWidget {
  final List data;
  final String? hinText;

  const DropMenuMotivoAusencia({Key? key, required this.data, this.hinText})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final estadoCompra =
        Provider.of<AusenciasController>(context, listen: true);
    ...
    return Container(
      ...
      child: Container(
        ...
        child: DropdownButton(
          ...
          value: estadoCompra.labelMotivoAusencia,
          style: GoogleFonts.lexendDeca(
          ...
          onChanged: (value) {
            ...
            Provider.of<AusenciasController>(context, listen: false)
                .setLabelMotivoAusencia( value.toString());
